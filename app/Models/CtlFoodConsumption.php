...
class CtlFoodConsumption extends Model
{
    use HasFactory, UserLog, Exclude, BelongsToThrough;

    protected $fillable = [
        'id', 'farm_id', 'cattle_id', 'cattle_food_id', 'date', 'value',
    ...
    public function cattleFood()
    {
        return $this->belongsTo(CattleFood::class, 'cattle_food_id');
    }
