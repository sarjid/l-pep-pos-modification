...
class MonthlySaleReportDataTable extends DataTable
{
    protected $exportClass = MonthlySaleReportExport::class;
    ...
    public function query()
    {
        ...
        return Sale::query()
            ->whereMonth('sale_date', $request->month ?? date('m'))
            ->addSelect([
    ...
    public function html()
    {
        return $this->builder()
            ...
            ->drawCallback("function() {
                $('#data-table > tfoot > tr > th:nth-child(6)').text(this.api().ajax.json().sums.total_amount);
                $('#data-table > tfoot > tr > th:nth-child(7)').text(this.api().ajax.json().sums.paying_amount);
    ...
    {
        return 'MonthlySaleReport_' . date('Y-m-d_h-ia');
    }
}
