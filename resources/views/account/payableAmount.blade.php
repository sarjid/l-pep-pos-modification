    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card-box table-responsive mt-4" style="border-top: 3px solid #157c34;">
                <div class="row">
                    <div class="col-md-3">
                        <h4 class="m-t-0 header-title mt-2"><b>{{ __('page.account2report')[8] }}</b></h4>
                    </div>
                    <div class="col-md-9">
                ...
                <table id="datatable-buttons" class="table table-bordered table-hover mt-4" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        @foreach ($purchases as $purchase)
                            <tr>
                                ...
                                <td>{{ $purchase->total - $purchase->total_pay }}</td>
                            </tr>
                        @endforeach
                    ...
                    <tfoot>
                        <tr>
                            <th colspan="4"></th>
                            <th>Total</th>
                            <th>{{ $purchase->sum('total') - $purchase->sum('total_pay') }}</th>
                        </tr>
                    </tfoot>
                </table>
            </div>
