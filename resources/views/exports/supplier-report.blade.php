    ...
    <tbody>
        @foreach ($collection as $item)
            <tr>
                ...
                <td style="text-align: center; vertical-align: center;">{{ $item['purchase_count'] }}</td>
                <td style="text-align: center; vertical-align: center;">{{ $item['total_purchase'] }}</td>
    ...
    <tfoot>
        <tr>
            ...
            <td style="font-weight: bold; text-align: center; vertical-align: center;">
                {{ $collection->sum('purchase_count') }}
            </td>
            <td style="font-weight: bold; text-align: center; vertical-align: center;">
                {{ $collection->sum('total_purchase') }}
            </td>
            <td style="font-weight: bold; text-align: center; vertical-align: center;">
