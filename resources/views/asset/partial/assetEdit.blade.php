...
<div>
    ...
    <form>
        ...
        <div class="form-group">
            ...
            <input type="date" name="expanse_date" value="{{ $expense->asset_date }}" class="form-control" required>
        </div>
            ...
            <select name="expense_type_id" class="form-control" id="" required>
                ...
                @foreach ($expense_types as $asset_category)
                    <option value="{{ $asset_category->id }}"
                        {{ $asset_category->id == $expense->asset_category_id ? 'selected' : '' }}>
                        {{ $asset_category->asset_category }}</option>
                @endforeach
            </select>
        </div>
