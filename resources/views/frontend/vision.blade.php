                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">{{ __('frontend.vision') }}</li>
                            </ol>
                        </nav>
                        <h1 class="pagetitle__heading">{{ __('frontend.vision') }}</h1>
                    </div><!-- /.col-lg-12 -->
                </div><!-- /.row -->
            </div><!-- /.container -->
        </section><!-- /.page-title -->
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-7">
                        <div class="row heading heading-2">
                            ...
                            <div class="col-sm-12">
                            <p class="heading__desc mb-30">{{ __('frontend.vision_highlight') }}</p>
                                <p>{{ __('frontend.vision_content') }}</p>
                            </div><!-- /.col-lg-7 -->
                        </div><!-- /.row -->
                    </div><!-- /.col-lg-7 -->
                </div><!-- /.row -->
